...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(0, 0, 981, 551))
        font = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.saveVehiclePushButton.setGeometry(QRect(300, 230, 101, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.printBarcodePushButton.setGeometry(QRect(420, 230, 111, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.vehicleCatalogTableWidget.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.vehicleCatalogTableWidget.setRowCount(99)
        self.vehicleCatalogTableWidget.setColumnCount(9)
        ...
        self.vehiclePictureLabel.setGeometry(QRect(550, 10, 281, 211))
        ...
        self.removeVehiclePushButton.setGeometry(QRect(550, 230, 101, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.updatePicturePushButton.setGeometry(QRect(420, 100, 91, 24))
        self.updatePicturePushButton.setFont(font1)
        self.updatePicturePushButton.setStyleSheet(u"background-color: rgb(85, 85, 255);\n"
"color: rgb(255, 255, 255);")
        ...
        self.printReportPushButton.setGeometry(QRect(710, 80, 61, 23))
...
"background-color: rgb(220, 162, 25);")
        ...
        self.diaryTableWidget.setGeometry(QRect(20, 160, 951, 321))
        ...
        self.getReportPushButton.setGeometry(QRect(640, 80, 61, 23))
...
"color: rgb(255, 255, 255);")
        ...
        self.lineEdit.setGeometry(QRect(520, 80, 113, 20))
        self.label = QLabel(self.reportsTab)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(520, 60, 71, 16))
        self.tabWidget.addTab(self.reportsTab, "")
        self.maintanceTab = QWidget()
        self.maintanceTab.setObjectName(u"maintanceTab")
        self.frame = QFrame(self.maintanceTab)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(0, 0, 371, 481))
        ...
        self.vehicleTypeTableWidget.setGeometry(QRect(10, 60, 341, 221))
        ...
        self.vehicleTypeAddLineEdit.setGeometry(QRect(10, 30, 241, 20))
        ...
        self.vehicleTypeAddPushButton.setGeometry(QRect(260, 30, 91, 23))
...
"color: rgb(255, 255, 255);")
        self.vechicleTypeDeletePushButton = QPushButton(self.frame)
        self.vechicleTypeDeletePushButton.setObjectName(u"vechicleTypeDeletePushButton")
        self.vechicleTypeDeletePushButton.setGeometry(QRect(260, 300, 91, 23))
        self.vechicleTypeDeletePushButton.setFont(font1)
        self.vechicleTypeDeletePushButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.vechicleTypeDeletePushButton.setStyleSheet(u"background-color: rgb(255, 0, 0);\n"
"color: rgb(255, 255, 255);")
        ...
        self.frame_2 = QFrame(self.maintanceTab)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setGeometry(QRect(390, 0, 371, 481))
        ...
        self.reasonAddTableWidget.setGeometry(QRect(10, 60, 341, 221))
        self.reasonAddTableWidget.setRowCount(10)
        self.reasonAddTableWidget.setColumnCount(1)
...
"color: rgb(255, 255, 255);")
        self.reasonDeletePushButton = QPushButton(self.frame_2)
        self.reasonDeletePushButton.setObjectName(u"reasonDeletePushButton")
        self.reasonDeletePushButton.setGeometry(QRect(260, 300, 91, 23))
        self.reasonDeletePushButton.setFont(font1)
        self.reasonDeletePushButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.reasonDeletePushButton.setStyleSheet(u"background-color: rgb(255, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.reasonAddLabel = QLabel(self.frame_2)
        self.reasonAddLabel.setObjectName(u"reasonAddLabel")
        self.reasonAddLabel.setGeometry(QRect(10, 10, 121, 16))
        self.tabWidget.addTab(self.maintanceTab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.agbRestrictionCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
...
#if QT_CONFIG(tooltip)
        self.vehicleTypeComboBox.setToolTip(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.agbCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
#endif // QT_CONFIG(tooltip)
        self.agbCheckBox.setText(QCoreApplication.translate("MainWindow", u"Automaattivaihteet", None))
#if QT_CONFIG(tooltip)
        self.vehicleOwnerLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Valinnainen tieto", None))
#endif // QT_CONFIG(tooltip)
        self.saveVehiclePushButton.setText(QCoreApplication.translate("MainWindow", u"Tallenna", None))
        self.printBarcodePushButton.setText(QCoreApplication.translate("MainWindow", u"Ei lainattavissa", None))
...
#if QT_CONFIG(tooltip)
        self.ssnFilterLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Rajaa ajop\u00e4iv\u00e4kirja tietoja henkil\u00f6tunnuksen perusteella.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.registerFilterLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Rajaa ajop\u00e4iv\u00e4kirja tietoja rekisterinumeron perusteella.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.lineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Rajaa ajop\u00e4iv\u00e4kirja tietoja ajon tarkoituksen perusteella.", None))
#endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("MainWindow", u"Tarkoitus", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.reportsTab), QCoreApplication.translate("MainWindow", u"Raportit", None))
#if QT_CONFIG(tooltip)
        self.vehicleTypeTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"Voit poistaa ajoneuvotyypin valitsemalla sen taulukosta. Jos tyypill\u00e4 on jo ajop\u00e4iv\u00e4kirjamerkint\u00f6j\u00e4, poistaminen ei ole mahdollista", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.vehicleTypeAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Kirjoita kentt\u00e4\u00e4n lis\u00e4tt\u00e4v\u00e4 ajoneuvotyyppi ja paina Lis\u00e4\u00e4-painiketta. Painike tulee n\u00e4kyviin kirjoittaessasi kentt\u00e4\u00e4n.", None))
#endif // QT_CONFIG(tooltip)
        self.vehicleTypeAddPushButton.setText(QCoreApplication.translate("MainWindow", u"Lis\u00e4\u00e4", None))
        self.vechicleTypeDeletePushButton.setText(QCoreApplication.translate("MainWindow", u"Poista", None))
        self.vehicleTypeAddLabel.setText(QCoreApplication.translate("MainWindow", u"Ajoneuvotyypit", None))
#if QT_CONFIG(tooltip)
        self.reasonAddTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"Voit poistaa ajon tarkoituksen valitsemalla sen taulukosta ja painamalla Poista-painiketta. Jos tarkoitus on jo k\u00e4ynniss\u00e4, poistaminen ei ole mahdollista", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.reasonAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"Kirjoita kentt\u00e4\u00e4n ajon tarkoitus ja paina Lis\u00e4\u00e4-painiketta. Painike tulee n\u00e4kyviin kirjoittaessasi kentt\u00e4\u00e4n.", None))
#endif // QT_CONFIG(tooltip)
        self.reasonAddPushButton.setText(QCoreApplication.translate("MainWindow", u"Lis\u00e4\u00e4", None))
        self.reasonDeletePushButton.setText(QCoreApplication.translate("MainWindow", u"Poista", None))
        self.reasonAddLabel.setText(QCoreApplication.translate("MainWindow", u"Ajon tarkoitus", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.maintanceTab), QCoreApplication.translate("MainWindow", u"Yll\u00e4pito", None))
